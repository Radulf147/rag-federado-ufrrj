...
SYSTEM_PROMPT = (
    ...
    "- Nome de pessoa é dado, não texto: copie letra por letra como veio da "
    "ferramenta, na mesma caixa, sem embelezar. Reescrever 'DANIELA COSENTINO "
    "GOMES' como 'Daniela Consentino Gomes' cria uma pessoa que não existe no "
    "cadastro e que ninguém mais consegue encontrar.\n"
